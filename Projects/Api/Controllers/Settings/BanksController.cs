...
using NUCA.Projects.Application.Settings.Banks.Commands.CreateBranch;
using NUCA.Projects.Application.Settings.Banks.Commands.CreateMainBank;
using NUCA.Projects.Application.Settings.Banks.Commands.DeleteBranch;
using NUCA.Projects.Application.Settings.Banks.Commands.DeleteMainBank;
using NUCA.Projects.Application.Settings.Banks.Commands.UpdateBranch;
using NUCA.Projects.Application.Settings.Banks.Commands.UpdateMainBank;
using NUCA.Projects.Application.Settings.Banks.Queries;
using NUCA.Projects.Application.Settings.Banks.Queries.CanDeleteBranch;
using NUCA.Projects.Application.Settings.Banks.Queries.CanDeleteMainBank;
using NUCA.Projects.Application.Settings.Banks.Queries.GetBanksAndBranches;
using NUCA.Projects.Application.Settings.Banks.Queries.GetMainBank;
using NUCA.Projects.Application.Settings.Banks.Queries.GetMainBankBranches;
using NUCA.Projects.Application.Settings.Banks.Queries.GetMainBanks;
