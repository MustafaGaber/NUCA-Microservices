...
using NUCA.Projects.Application.Settings.WorkTypes.Commands;
using NUCA.Projects.Application.Settings.WorkTypes.Commands.CreateWorkType;
using NUCA.Projects.Application.Settings.WorkTypes.Commands.DeleteWorkType;
using NUCA.Projects.Application.Settings.WorkTypes.Commands.UpdateWorkType;
using NUCA.Projects.Application.Settings.WorkTypes.Queries.CanDeleteWorkType;
using NUCA.Projects.Application.Settings.WorkTypes.Queries.GetWorkType;
using NUCA.Projects.Application.Settings.WorkTypes.Queries.GetWorkTypes;
