...
namespace NUCA.Projects.Api.Controllers.Adjustments
{
    ...
    public class ManpowerLetterController : BaseController
    {
        ...
        public ManpowerLetterController(IGetAdjustmentQuery getAdjustmentQuery, IJsReportMVCService jsReportMVCService)
        {
        ...
        public async Task<IActionResult> Get(long id)
        {
            ...
            var content = await _jsReportMVCService.RenderViewToStringAsync(HttpContext, RouteData, "ManpowerLetter", adjustment);
