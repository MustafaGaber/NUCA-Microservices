...
using NUCA.Projects.Application.Settlements.Queries.GetJournalVoucherModel;
...
namespace NUCA.Projects.Api.Controllers.Settlements
{
    ...
    {
        private readonly IGetJournalVoucherSettlementQuery _getSettlementQuery;
        private readonly IJsReportMVCService _jsReportMVCService;

        public JournalVoucherController(IGetJournalVoucherSettlementQuery getSettlementQuery, IJsReportMVCService jsReportMVCService)
        {
        ...
        public async Task<IActionResult> Get(long id)
        {
            ...
            var content = await _jsReportMVCService.RenderViewToStringAsync(HttpContext, RouteData, "JournalVoucher", settlement);
