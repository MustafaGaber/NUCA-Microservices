...
namespace NUCA.Projects.Api.Controllers.Settlements
{
    ...
    [ApiController]
    public class ManpowerLetterController : BaseController
    {
        private readonly IGetSettlementQuery _getSettlementQuery;
        private readonly IJsReportMVCService _jsReportMVCService;

        public ManpowerLetterController(IGetSettlementQuery getSettlementQuery, IJsReportMVCService jsReportMVCService)
        {
        ...
        public async Task<IActionResult> Get(long id)
        {
            ...
            var content = await _jsReportMVCService.RenderViewToStringAsync(HttpContext, RouteData, "ManpowerLetter", settlement);
