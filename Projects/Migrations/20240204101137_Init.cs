        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommercialIndustrialTaxPercent = table.Column<double>(type: "REAL", nullable: false),
                    SelfEmploymentTaxPercent = table.Column<double>(type: "REAL", nullable: false),
                    Created = table.Column<DateTime>(type: "TEXT", nullable: false),
                    LastModified = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedBy = table.Column<string>(type: "TEXT", nullable: false),
                    UpdatedBy = table.Column<string>(type: "TEXT", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxFile = table.Column<string>(type: "TEXT", nullable: true),
                    ElectronicInvoice = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxAuthorityId = table.Column<long>(type: "INTEGER", nullable: true),
                    FinalGuaranteeLetterExpiryDate = table.Column<DateOnly>(type: "TEXT", nullable: true),
                    AdvancePaymentGuaranteeLetterExpiryDate = table.Column<DateOnly>(type: "TEXT", nullable: true),
                    InsurancePolicyExpiryDate = table.Column<DateOnly>(type: "TEXT", nullable: true),
                    WaivedToBank = table.Column<bool>(type: "INTEGER", nullable: false),
                    AssigneeMainBankId = table.Column<long>(type: "INTEGER", nullable: true),
                    AssigneeBankBranchId = table.Column<long>(type: "INTEGER", nullable: true),
                    FromLedgerId = table.Column<long>(type: "INTEGER", nullable: true),
                    ToLedgerId = table.Column<long>(type: "INTEGER", nullable: true),
                    AdvancePaymentLedgerId = table.Column<long>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupervisionCommission = table.Column<double>(type: "REAL", nullable: false),
                    ...
                    RegularStampTax = table.Column<double>(type: "REAL", nullable: false),
                    AdditionalStampTax = table.Column<double>(type: "REAL", nullable: false),
                    ResourceDevelopmentTax = table.Column<double>(type: "REAL", nullable: false),
                    CommercialIndustrialTax = table.Column<double>(type: "REAL", nullable: false),
                    SelfEmploymentTax = table.Column<double>(type: "REAL", nullable: false),
                    ValueAddedTaxPercent = table.Column<double>(type: "REAL", nullable: false),
                    ...
                    ConractStampTax = table.Column<double>(type: "REAL", nullable: false),
